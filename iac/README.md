...
> Some models, such as Claude Sonnet 3.7, which is used here, is provided by AWS only via cross-region inference profiles, which means you will have to request permission for all region it's provided. More details [here](https://docs.aws.amazon.com/bedrock/latest/userguide/inference-profiles-support.html)
...
| Name                                                                                                           | Source                             | Version |
| -------------------------------------------------------------------------------------------------------------- | ---------------------------------- | ------- |
| <a name="module_agent_action_group_lambda"></a> [agent_action_group_lambda](#module_agent_action_group_lambda) | ./modules/lambda                   | n/a     |
| <a name="module_agent_entrypoint_lambda"></a> [agent_entrypoint_lambda](#module_agent_entrypoint_lambda)       | ./modules/lambda                   | n/a     |
...
| <a name="input_kb_rag_mode"></a> [kb_rag_mode](#input_kb_rag_mode)                                              | value                                                         | `string` | `"agentic-rag"` |    no    |
